...
BASELINE = {'project_return_aftertax_npv': np.array([7876459.5, 7875551.5,
                                                     ...
                                                     7871078.5, 7871352.5,
                                                     7871153.5, 7869134.5]),
            'lcoe_real': np.array([71.007614, 69.21741, 67.24552, 68.67675,
                                   68.829605, 64.257965, 61.39551, 61.83265,
                                   61.51415, 58.43599]),
            'lcoe_nom': np.array([89.433525, 87.17878, 84.6952, 86.497826,
                                  86.69034, 80.932396, 77.327156, 77.87773,
                                  77.476585, 73.59966]),
...
def test_rev_run_gen_econ(points=slice(0, 10), year=2012, max_workers=1):
    ...
    Gen.reV_run('windpower', points, sam_files, res_file,
                ...
                max_workers=max_workers, sites_per_worker=3, out_fpath=fn_gen,
                dirout=OUT_DIR)
