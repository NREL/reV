...
class SupplyCurveField(FieldEnum):
    ...
    TRANS_GID = "trans_gid_m"
    TOTAL_LCOE_FRICTION = "total_lcoe_friction_m"
    TOTAL_LCOE = "total_lcoe_m"
    ...
    POI_LAT = "poi_lat_m"
    POI_LON = "poi_lon_m"
    REINFORCEMENT_POI_LAT = "reinforcement_poi_lat_m"
    REINFORCEMENT_POI_LON = "reinforcement_poi_lon_m"
    REINFORCEMENT_COST_PER_MW = "reinforcement_cost_per_mw_m"
    REINFORCEMENT_DIST_KM = "reinforcement_dist_km_m"
